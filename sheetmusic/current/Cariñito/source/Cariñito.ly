...
melody = \relative c' {
  ...
  \repeat volta 2 {
    ...
    <d f>16 <f a>8-. <d f>16   <d f>16 <f a>8-. <d f>16   a'16 g a g  f8-. d-.
    ...
    a'8.-.\mp\< e16  r4 r a8 g  | a8.-. f16  r4 r f8 g  |  a4.\f\! c8  g4.  a8 |
    \alternative {
      {  f8. d16  r4 r2  | } {  f8. d16  r4 r2  | }
    }
  } % end repeat
  \fine
...
bass = \relative c {
  ...
  \repeat volta 2 {
    ...
    f4  c8 f f,4 c'8 f  | f,4  c'8 f f,4 c'8 f  | f,4  c'8 f f,4 c'8 f  | d4 a8 a  d a bes c
    \bar "||"

    \break
    \section
    \sectionLabel \markup { \bold \box "Verse" }
    d4 a8 d  f,4 c'8 d  |  f4 c8 f  f,4  c'8 f  | f,4  c'8 c  a4 e'8 a  |  d,4 c8 d  r16 f,16 f8  g a  |
    d4 a8 d  f,4 c'8 d  |  f4 c8 f  f,4  c'8 f  | f,4  c'8 c  a4 e'8 a  |  d,4 c8 d  r16 f,16 f8  g a  |
...
\book {
	\score { <<
		...
		% Group: CountermelodyHigh
		\new Staff \with { \consists "Volta_engraver" instrumentName = "CountermelodyHigh" } {  \set Staff.midiInstrument = #"alto sax" \clef treble
			\tempo  4=100
			\override Score.RehearsalMark.self-alignment-X = #LEFT
			\countermelodyHigh
		}
		% Group: CountermelodyLow
		\new Staff \with { \consists "Volta_engraver" instrumentName = "CountermelodyLow" } {  \set Staff.midiInstrument = #"alto sax" \clef treble
			\tempo  4=100
			\override Score.RehearsalMark.self-alignment-X = #LEFT
			\countermelodyLow
		}
