...
\book {
	\score { <<
		...
		% Group: Melody
		\new Staff \with { \consists "Volta_engraver" instrumentName = "Melody (Call)" } {  \set Staff.midiInstrument = #"trumpet" \clef treble
			\tempo  4=180
			\override Score.RehearsalMark.self-alignment-X = #LEFT
			\melody_call
		}
		\new Staff \with { \consists "Volta_engraver" instrumentName = "Melody (Response)" } {  \set Staff.midiInstrument = #"trumpet" \clef treble
			\tempo  4=180
			\override Score.RehearsalMark.self-alignment-X = #LEFT
			\melody_response
		}
